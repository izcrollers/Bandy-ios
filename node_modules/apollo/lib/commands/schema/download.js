    ...
    async run() {
        ...
        const tasks = new Listr([
            ...
            },
            {
                ...
                task: async (ctx) => {
                    await util_1.promisify(localfs_1.fs.writeFile)(args.output, JSON.stringify((await graphql_1.execute(ctx.schema, graphql_1.parse(graphql_1.introspectionQuery))).data));
                }
            }
        ]);
        return tasks.run();
